...
class Student:
    def __init__(self,root):
        ...
        img=Image.open(r"img\pavan.jpg")
        ...
        img2=Image.open(r"img\smart-attendance.jpg")
        ...
        dep_combo["values"]=("Select Department","Computer","Electronics","Physics","Mathematics")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select course","Bsc","BE","BCA","BA")
        ...
        take_photo_btn=Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=45,font=("times new roman",13,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0)

        back_btn=Button(btn_frame1,text="Back",command=self.root.destroy,width=25,font=("times new roman",13,"bold"),bg="blue",fg="white")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                messagebox.showinfo("Result","Generating data sets complected!!!",parent=self.root)
            except Exception as es:
                messagebox.showerror("Error",f"Due To :{str(es)}",parent=self.root)   
